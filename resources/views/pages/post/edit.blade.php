<x-master-layout>
      ...
      <h3 class = " mb-3 ">Editing: {{$post->id}}</h3 >
      <div class="row">
        <div class="col-6 mt-2">
          ...
          <form action="/post/update/{{$post->id}}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <input type="text" value="{{old('title',$post->title)}}" name="title" class="form-control @if($errors->first('title'))is-invalid @endif" id="inputTitle" > 
